...
import ClaimSafety from './ClaimSafety';
...
const Profile = (props) => {
    ...
    return (
        <>  
            {popUP && <div onClick={handleOnCloseWindow} className="backgroundClaimPop"></div>}
           {popUP && <ClaimSafety  />}
            <div className={dash.dash3}>
                <Sidebar revSection = {revSection} setRevSection = {setRevSection} gameSection= {gameSection} setGameSection = {setGameSection} />
                        ...
                        <div className="developerEditShare">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a onClick={handleOnClaim} href="#" class="btn btn-primary my-5">Claim Safety Net</a>
